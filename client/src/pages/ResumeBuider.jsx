...
const ResumeBuider = () => {
  ...
  const saveResume= async()=>{
    try {
      ...
      //remove image from upated resumedata
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <hr className='absolute top-0 left-0 h-1 bg-gradient-to-r from-green-500 to-green-600 border-none transition-all
              ...
              <button onClick={()=>{toast.promise(saveResume, {loading: 'Saving...'})}} className='bg-gradient-to-br from-green-100 to-green-200 ring-green-300 text-green-600 ring
            ...
            <div className='relative w-full'>
              ...
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                {resumeData.public && (
                     <button 
                      onClick={handleShare}
                      className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-blue-100 to-blue-200
                 ...
                 <Share2Icon className='size-4' /> Share
                    ...
                    <button 
                      ...
                      className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-r from-purple-100 to-purple-200 text-purple-600
