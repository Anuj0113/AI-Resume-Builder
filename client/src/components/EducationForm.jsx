                ...
                {data.map((education, index) => (
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            ...
                            value={education.institute || ""} onChange={(e) => updateEducation(index, "institute", e.target.value)} />
                        ...
                        className='px-3 py-2 text-sm rounded-lg border border-gray-300 focus:outline-none focus:border-green-500 w-full'
