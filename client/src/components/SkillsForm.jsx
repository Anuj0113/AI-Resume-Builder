  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            ...
            className='flex-1 px-3 py-2 text-sm rounded-lg border border-gray-300 focus:outline-none focus:border-green-500'
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 8-12 relevant skills. Include both technical and soft skills.</p>
        </div>
    </div>
  )
}
